...
const TRANSLATIONS = {
  fr: {
    ...
    ctxTourDePiste: 'Tracer un tour de piste',
    ctxTourDePisteDeleteOne: 'Supprimer ce tour de piste',
    ctxTourDePisteClear: 'Effacer les tours de piste',
    tdpTitre: 'Tour de piste',
    tdpPisteLabel: 'Piste (sens d\'atterrissage)',
    tdpPisteMot: 'Piste',
    tdpAucunePiste: 'Aucune piste géolocalisée sur ce terrain.',
    tdpSensLabel: 'Sens du circuit',
    tdpSensGauche: 'Main gauche',
    tdpSensDroite: 'Main droite',
    tdpMontee: 'Montée initiale (NM)',
    tdpTraversier: 'Vent traversier (NM)',
    tdpFinale: 'Finale (NM)',
    tdpAltitude: 'Altitude du circuit (ft)',
    tdpTracer: 'Tracer',
    tdpErrPiste: 'Choisissez une piste.',
    tdpErrMontee: 'Montée initiale : de 0,1 à 3 NM.',
    tdpErrTraversier: 'Vent traversier : de 0,1 à 3 NM.',
    tdpErrFinale: 'Finale : de 0,1 à 4 NM.',
    tdpErrAltitude: 'Altitude : de 500 à 3000 ft.',
    layerPistes: 'Pistes (zoom 12)',
    layerParkings: 'Parkings (zoom 15)',
    parkingsBaseAncienne: 'Aucune place dans la base : réimportez les aéroports (Importer → Aéroports MSFS2024).',
  ...
  en: {
    ...
    ctxTourDePiste: 'Draw a traffic pattern',
    ctxTourDePisteDeleteOne: 'Delete this traffic pattern',
    ctxTourDePisteClear: 'Clear traffic patterns',
    tdpTitre: 'Traffic pattern',
    tdpPisteLabel: 'Runway (landing direction)',
    tdpPisteMot: 'Runway',
    tdpAucunePiste: 'No geolocated runway at this airfield.',
    tdpSensLabel: 'Pattern direction',
    tdpSensGauche: 'Left hand',
    tdpSensDroite: 'Right hand',
    tdpMontee: 'Upwind leg (NM)',
    tdpTraversier: 'Crosswind leg (NM)',
    tdpFinale: 'Final (NM)',
    tdpAltitude: 'Pattern altitude (ft)',
    tdpTracer: 'Draw',
    tdpErrPiste: 'Select a runway.',
    tdpErrMontee: 'Upwind leg: 0.1 to 3 NM.',
    tdpErrTraversier: 'Crosswind leg: 0.1 to 3 NM.',
    tdpErrFinale: 'Final: 0.1 to 4 NM.',
    tdpErrAltitude: 'Altitude: 500 to 3000 ft.',
    layerPistes: 'Runways (zoom 12)',
    layerParkings: 'Parking (zoom 15)',
    parkingsBaseAncienne: 'No parking spots in the database: re-import the airports (Import → MSFS2024 airports).',
